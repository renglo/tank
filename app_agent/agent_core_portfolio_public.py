...
class AgentCorePortfolioPublic:
    def __init__(self):
    ...
    def validate_interpret_openai_llm_response(self, raw_response: dict) -> tuple[bool, str]:
        ...
        #   # While not official, there are instances where you can receive both
    ...
    def run(self,payload):
        ...
        '''
        This agent uses no orgs and the user is public (it has not been authenticated)
        It operates in the portfolio level. 
        It indeed affects orgs but it can jump from one to the other
        '''
        ...
        # _all_ indicates this is a portfolio level agent (all orgs) 
        context.org = '_all'
